...
import com.example.mdproject.gstbilling.data.GSTBillingContract;
import com.example.mdproject.gstbilling.utils.NumberToWord;
import com.example.mdproject.gstbilling.utils.PDFUtils;
...
public class SavePDFActivity extends AppCompatActivity {
    ...
    public static void printTotalDetails(int totalQty, float totalTaxableValue, float totalSingleGst, float totalAmount){
        ...
        totalAmountInWordsTv.setText("Amount: " + NumberToWord.getNumberInWords(String.valueOf((int)totalAmount)));
